...
A full-stack AI-powered loan eligibility and credit scoring application. Users submit a loan application, receive a real-time credit score based on key financial metrics, and get a personalised AI-generated explanation of their decision.
...
- **Credit Scoring Engine** — Calculates a score from 0–950 based on real financial metrics
- **Debt-to-Income Ratio (DTI)** — Assesses monthly debt obligations against income
- **Loan-to-Income Ratio (LTI)** — Affordability check based on loan size vs income
...
- **Approve / Refer / Decline Outcomes** — Clear decision bands
...
After scoring, the application sends the applicant's full financial profile to OpenAI GPT-4o-mini. The AI generates a personalised explanation that:
